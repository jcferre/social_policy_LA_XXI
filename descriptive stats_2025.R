...
CCT_coverage_ppl %>%
  ...
  geom_text(aes(label = round(cct_benef_LA/1000000, 0)), nudge_y = 5000000) +
  theme_minimal() +
  labs(y = "Millions of beneficiaries")

ggsave("figure 2.1.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 7, height = 4, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.2.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 7, height = 4, device='png', dpi=320, bg = "white")
...
consolidated_score_filled %>%
  ...
  geom_text(aes(label = round(pen_rate_occup_all)), position = position_dodge(1), color = "black")+
  scale_fill_grey(start=0.6, end=0.8) +
  labs(y = "Pension contribution/enrolment rate (%)", x = "Country")+
  theme_minimal()

ggsave("figure 2.3.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
...
ggsave("figure 2.4.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       units="in", width=8, height=5, dpi=320, device = "png", bg = "white")
# also possible: 
# ggsave("test.tiff", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
#       units="in", width=10, height=7, dpi=320, compression = 'lzw', bg = "white")
...
ggsave("figure 2.5.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
explanatory_cepal_wide %>%
  ...
  labs(y = "GDP growth (%)",  linetype = "Country") 

ggsave("figure 4.1.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 4.3.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 5.1.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 5.2.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 5.3.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggplot(priv_ed_primLA11, aes(x = year, y = priv_ed_prim)) + # Note that the data for this (and the geom_smooth)
  ...
  labs(y = "Percentage", linetype = "Country", color = "Country") +
  theme_minimal()

ggsave("figure 2.6.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.13.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggplot(master_data3_LA9, aes(x = year, y = UHC_index)) + 
  geom_line(data = master_data3_LA9[!is.na(master_data3_LA9$UHC_index),], 
            aes(linetype = ccode)) + 
  geom_smooth(se = FALSE, color = "grey", size = 2) +
  labs(linetype = "Country", y = "UHC Index")+
  theme_minimal()


ggsave("figure 2.7.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.8.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.9.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.11.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.10.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 2.12.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
ggsave("figure 6.1.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")

ggplot(master_data3_Ar_Cl_Uy, aes(year, govt_hexp_pctGDP_WB, linetype = ccode)) +
  geom_line() +
  theme_minimal()+
  labs(y = "Percentage of the GDP")  +
  coord_cartesian(ylim = c(0, 8))

ggsave("figure 6.2.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")

ggplot(master_data3_Ar_Cl_Uy, aes(year, gov_hexp_ppp_WB_cnstnt, linetype = ccode)) +
  geom_line() +
  theme_minimal()+
  labs(y = "US Dollars")

ggsave("figure 6.3.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
oop_pct_table <- health_exp_Ar_Cl_Uy %>%
  ...
  select(country, ccode, year, value)

ggplot(oop_pct_table, aes(year, value, linetype = ccode)) +
  theme_minimal()+
  geom_line() +
  coord_cartesian(ylim = c(0, 50))

ggsave("figure 6.4.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
...
chl_health_dist <- read_xlsx("/Users/juan/Documents/Dissertation/DATA/Chile/health insurance distribution.xlsx") %>%
  pivot_longer(cols = c(2:4), names_to = "Insurance")

ggplot(chl_health_dist, aes(x = Quintile, y = value, fill = Insurance)) +
  geom_col() +
  geom_text(aes(label = value), 
            position = position_stack(vjust = 0.5), 
            color = "white", size = 4) +
  labs(x = "Income Quintile", y = "Percentage") +
  scale_fill_grey()

ggsave("figure 6.7.png", path = "/Users/juan/Documents/Research/Welfare in Latin America - book/manuscript/final set of files to submit/figures", 
       width = 8, height = 5, device='png', dpi=320, bg = "white")
